...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 29 Mars 2017 à 23:33
...
(7, '2017-03-01', 'Corgiat Olivia, étudiante à ISEFAC', '../img/interview/Olivia.png', NULL, 'Après un Bac ES, Corgiat Olivia a intégré le DUT MMI, Métiers du Multimédia et de l’Internet de Lens pour sa polyvalence mais surtout pour acquérir davantage de connaissance dans le domaine de la communication. ', '<p style="text-indent:2em" text-align="justify">Après un Bac ES, Corgiat Olivia a intégré le DUT MMI, Métiers du Multimédia et de l’Internet de Lens pour sa polyvalence mais surtout pour acquérir davantage de connaissance dans le domaine de la communication. « La formation MMI, est une formation complète et polyvalente. C’est avec cette formation que j’ai appris le plus. C’est vraiment un atout pour les étudiants. » confie Olivia.</p>\r\n<br />\r\n<br />\r\n<strong>Un pas dans événementiel</strong>\r\n<br />\r\n<p style="text-indent:2em" text-align="justify">Une fois diplômée, elle a décidé de se spécialiser dans l’événementiel et a opté pour la Licence « Chef de Projet Événementiel » à ISEFAC Bachelor de Lille. Grâce à ses compétences acquises en MMI, elle a eu l’opportunité d’intégrer directement la 3ème année. Celles-ci lui ont d’ailleurs permis d’avoir une certaine avance dans certaines matières telles que l’infographie et l’audiovisuel mais également un retard dans d’autres comme la budgétisation événementielle ou encore la scénographie. En arrivant dans cette Licence, elle a dû fournir énormément de travail. « Il y a beaucoup de pratique, […] chaque groupe doit monter un événement pour la fin d’année. Ce qui m’a changé en licence c’est le travail à la maison, il y en a énormément, beaucoup de dossiers et projets avec des deadlines assez courtes [...] mais avec une bonne motivation tout est possible » a-t-elle confié. Grâce à ces longues heures d’études, elle a pu obtenir de nombreuses connaissances dans son domaine de prédilection, notamment sur le budget, la logistique et aussi la législation.</p> \r\n<br />\r\n<br />\r\n<strong>Et un peu de communication</strong>\r\n<br />\r\n<p style="text-indent:2em" text-align="justify">Après sa licence, elle a choisi de rester à ISEFAC pour continuer en alternance un master « Manager de la communication 360° et de l’innovation » pour compléter son savoir-faire et enrichir ses compétences car selon elle « la communication et l’événementiel sont 2 domaines liés ».</p>\r\n<br />\r\n<p style="text-indent:2em" text-align="justify">Actuellement, elle passe sa formation à l’Institut des Métiers d’Art et du Patrimoine, une association mettant en valeur les artisans de la région, groupe qui l’avait accueillie en stage il y a quelques année. Certains étudiants appréhendent ce type de formation cependant Olivia rassure en affirmant que « la recherche d’entreprise [à ISEFAC] est bien encadrée par l’école, une personne en est même responsable, et des événements avec des entreprises sont organisés au sein de l’école tel que des speed recruting.» </p>\r\n<br />\r\n<strong>Un conseil ?</strong>\r\n<br />\r\n<i>« Il faut se construire un réseau professionnel, garder contact avec les anciens MMI »</i>\r\n', 2, 1, 1, 2),
(8, '2017-03-01', 'Valentin Baës, étudiant à EFFICOM', '../img/interview/Valentin.png', NULL, 'Valentin Baës, âgé de 20 ans, après avoir obtenu un Bac S suivi du DUT MMI, a directement enchainé avec EFFICOM qui est une école supérieure de Management, Design et technologies numériques.', '<p style="text-indent:2em">La formation MMI (les Métiers du Multimédia et de l’Internet) accueille de nombreux étudiants souhaitant acquérir des compétences variées que ce soit dans les domaines de l’audiovisuel, de la communication ou du web.\r\nMais où vont-ils une fois diplômé ? Avec cette polyvalence chacun doit trouver sa voie, son domaine de prédilection.</p> \r\n<br />\r\n<br />\r\n<p style="text-indent:2em">Valentin Baës, âgé de 20 ans, après avoir obtenu un Bac S suivi du DUT MMI, a directement enchainé avec EFFICOM qui est une école supérieure de Management, Design et technologies numériques. L’école axe son programme principalement sur le marketing.  Elle propose des formations de BAC+1 à BAC+5 en initiale mais également en alternance. Valentin a choisi cette 2ème option depuis le début de sa licence afin de consolider ses expériences dans le monde du travail. Il est actuellement chargé de communication/marketing chez Vekia. Lors de sa licence, il a dû produire un mémoire à rendre en fin d\'année, et préparer une soutenance sur une des 3 veilles qu’il a dû mener sur des sujets de son choix en rapport avec la communication / marketing / digital. Le Master est donc la continuité de la Licence mais dans une approche plus pratique globalement.</p>\r\n<br />\r\n<p style="text-indent:2em">Si tout se passe correctement pour Valentin, un CDI sera peut-être à la clé, une véritable opportunité pour lui d’entrer enfin dans la vie professionnelle.</p>\r\n<br />\r\n<strong>Un conseil ?</strong><br />\r\n<p style="text-indent:2em">Son conseil pour les actuels MMI qui souhaiteraient suivre un parcours semblable au siens est que tous doivent « se former sois même, ne pas attendre tous des cours, développer une connaissance du web et une polyvalence. »\r\nCette polyvalence peut avoir quelques inconvénients pour certains, mais c’est ce qui est très attendue et appréciée en entreprise. C’est pourquoi il est important de « ne pas délaisser les matières qui peuvent sembler moins intéressantes.» Cette formation offre de nombreux avantages par rapport aux autres.</p>\r\n<br />\r\n<br />\r\n<a href="www.efficom-lille.fr">efficom-lille.fr</a>\r\n', 2, 1, 1, 2),
(9, '2017-03-01', 'Alexis JOUEN, étudiant à Pôle 3D', '../img/interview/Alexis.png', '', 'Après un début d’incertitude, Alexis JOUEN, a trouvé son domaine de prédilection grâce aux nombreuses disciplines présentent à l’IUT. Aujourd’hui il est en 3ème année à Pôle 3D et il nous livre son expérience.', '<p style="text-indent:2em">Après un début d’incertitude, Alexis JOUEN, a trouvé son domaine de prédilection grâce aux nombreuses disciplines présentent à l’IUT. Aujourd’hui il est en 3ème année à Pôle 3D et il nous livre son expérience.</p>\r\n<br />\r\n<strong>Avant MMI que faisiez-vous ? Pourquoi avez-vous choisi cette formation ?</strong>\r\n<br />\r\n<p style="text-indent:2em">J\'ai choisi la formation MMI car je ne savais pas encore précisément le domaine qui m’attirait le plus. J\'ai pu grâce à cette formation voir concrètement plusieurs disciplines et mieux me diriger. Je sortais du Lycée donc je ne réalisais pas encore que mes choix étaient importants. Cette formation m\'a permis de réaliser beaucoup de choses. </p>\r\n<br />\r\n<strong>Quel a été votre cursus depuis que vous avez obtenu votre DUT ? </strong>\r\n<br />\r\n<p style="text-indent:2em">Directement en 2éme année à Pôle 3D grâce au DUT.\r\n <br /><br />\r\n<strong>Qu’avez-vous pensé du DUT ? A-t-il été un avantage à Pôle 3D ?</strong>\r\n<br />\r\n<p style="text-indent:2em">J\'ai adoré la formation elle est très bien. Ces deux années ont vraiment été de bons souvenirs. Cette formation a été un réel avantage à Pôle 3D, cela m\'a permis de rentrer directement en deuxième année et ne pas payer la première année. De plus quand je suis arrivé à Pôle 3D, il y avait des logiciels et des connaissances que mes camarades n’avaient pas vus, ce qui m\'a permis d\'apporté mon petit lots de connaissances. Et vice-versa, beaucoup de choses que j\'avais à apprendre d’eux, pour me mettre à niveaux, surtout au niveau artistique. Grâce à cela nous avons pu s\'échanger et avancer plus facilement.</p>\r\n<br />\r\n<strong>Pouvez-vous nous détailler ce que vous faites ? Quelles sont les matières principales ?</strong>\r\n<br />\r\n<p style="text-indent:2em">J\'apprends à réaliser des films d\'animations 3D. Je n\'ai pas de matières principales à proprement dit. Mes matières changent en fonction de la production du film. Cela commence de l\'écriture, au caractère design, au concept visuel, storyboard. <br />\r\nLes étapes sont globalisées dans ce qu\'on appelle la Pré-Production. On crée tout ce qui est nécessaire pour la bonne construction du film. <br />\r\nPuis on peut passer à l\'étape de la production, et commencer à réaliser le film. On doit modéliser nos personnages en 3D, puis les setuper, pour les skinnner. <br />\r\nPuis on doit modéliser les décors pour faire le Lighting. Puis faire l\'animation de personnages, Etc. Beaucoup d\'étapes sont à faire pour réaliser un film d\'animation 3D.</p>\r\n<br />\r\n<strong>Finalement qu’elle est votre étape préférée lors de la réalisation d’un film d’animation ?</strong>\r\n<br />\r\n<p style="text-indent:2em">Mon étape préférée est le compositing : essayer de rendre l\'image la plus belle possible tout en donnant un esprit artistique à l\'image. C\'est la finition, cette étape est très plaisante et permet de s\'exprimer artistiquement !</p>\r\n<br />\r\n<strong>En ce moment sur quoi travaillez-vous ?</strong>\r\n<br />\r\n<p style="text-indent:2em">En ce moment même je suis en pleine production d\'un film de 4min en 3D qui sortira d\'ici quelques mois. Un travail de 6 personnes sur un ans mais je ne peux pas encore en dire plus.</p>\r\n<br />\r\n<strong>Beaucoup d’étudiants aimeraient entrer dans cette école, y a-t-il quelque chose à savoir pour y entrer ? Faut-il un très haut niveau ?</strong>\r\n <br />\r\n<p style="text-indent:2em">Je conseille à ceux qui aspirent à venir dans cette école de travailler dès maintenant, d\'essayer de se démarquer le plus possible, de voir comment se réalise ce genre de film, de s\'enrichir culturellement, c\'est important. Et surtout de ne pas se forcer, d\'aller vers les choses qui nous attirent. Si leur choix est fait, il faut foncer et s\'accrocher. <br />\r\nIl faut avoir un réel intérêt pour le film d\'animation pour rentrer dans cette école, le niveau n\'est pas si important mais bien sûr, il faut savoir un minimum. Ce qui arrive naturellement juste en s\'intéressant au film d\'animations.</p>\r\n<br />\r\n<strong>Comment trouvez-vous l’ambiance à Pôle 3D ? Est-ce que vous la recommandez ?</strong>\r\n<br />\r\n<p style="text-indent:2em">Je conseille l\'ambiance à Pôle 3D, surtout au niveau de la camaraderie car il y a beaucoup d\'entraides qui malheureusement n\'est pas forcément là dans d\'autres écoles à cause de la concurrence. L\'ambiance est une ambiance de travail et de passion.</p>\r\n<br />\r\n<strong>Que pensez-vous faire plus tard ?</strong>\r\n<br />\r\n<p style="text-indent:2em">Je ne sais pas encore dans quelles "matières" en 3D je me positionne.</p>\r\n<br />\r\n<strong>Est-ce que vous auriez des conseils à donner à des personnes souhaitant avoir un parcours semblable au votre ?</strong>\r\n<br />\r\n<p style="text-indent:2em">Foncez, mais réfléchissez bien à vos choix. N\'ayez pas peur de la suite. Travaillez pour vous. </p>\r\n', 1, 1, 3, 2);
